    ...
    "paths": {
        ...
        "/api/v1/repairs": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "carId, description, cost; startedAt opcional (RFC3339)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateRepairRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdateRepairRequest"
                        }
                    }
                ],
                "responses": {
