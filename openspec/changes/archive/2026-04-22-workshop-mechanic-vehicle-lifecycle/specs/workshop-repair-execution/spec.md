# workshop-repair-execution Specification (new)
...
- THEN existe identificador de visita y estado mínimo **open** (nombre concreto en `design` / implementación)
...
Resumen; las obligaciones **MUST/SHALL** de mutación y la matriz pública viven en el delta `mvp-role-access` de este change. `client` **MUST NOT** en mutación de visita; el personal *staff* según reglas allí.
